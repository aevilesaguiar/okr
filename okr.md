...
|------------------------------------ -|-------------------------------------------------------------------------------------------------------|
|1 . ROOFSHOT(tiros no telhado)        |     são as metas difíceis, mas possíveis de serem realizadas. Entende-se que um                       | 
...
|                                      |     Revisar como os problemas estão sendo catalogados, ajustar as filas de atendimento e              |                     
...
|2 -moonshot( tiro para a lua)         |     são metas mais ambiciosas que deslocam o time da zona de conforto de forma                        |
